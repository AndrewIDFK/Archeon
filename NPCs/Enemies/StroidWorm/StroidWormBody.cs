...
namespace Archeon.NPCs.Enemies.StroidWorm
{
	...
	public class StroidWormBody : ModNPC
	{
		public override void SetStaticDefaults()
		{
			base.DisplayName.SetDefault("Stroid Defender");
		}	
		// Token: 0x060003C9 RID: 969 RVA: 0x00021BD4 File Offset: 0x0001FDD4
		...
		public override void HitEffect(int hitDirection, double damage)
		{
			if (base.npc.life <= 0)
			{
				...
				Gore.NewGore(base.npc.position, base.npc.velocity, base.mod.GetGoreSlot("Gores/StroidWormBodyGore"), 1f);
			}
		}
	}
}
