...
namespace Archeon.NPCs.Bosses.TheHallowedOne
{
	...
	public class HallowedOneShotNoMoving : ModProjectile
	{
		...
		public override void Kill(int timeLeft)
		{
			...
			for (int i = 0; i < 10; i++)
			{
				Dust.NewDust(base.projectile.position + base.projectile.velocity, base.projectile.width, base.projectile.height, base.mod.DustType("StroidDust1"), base.projectile.oldVelocity.X * 2.5f, base.projectile.oldVelocity.Y * 2.5f, 0, default(Color), 1f);
			}
			
			Projectile.NewProjectile(base.projectile.Center.X + 6.5f, base.projectile.Center.Y + 6.5f, projectile.velocity.X, projectile.velocity.Y - 11.1f, base.mod.ProjectileType("HallowedOneShotStraightUp"), base.projectile.damage, base.projectile.knockBack, Main.myPlayer, 0f, 0f);
