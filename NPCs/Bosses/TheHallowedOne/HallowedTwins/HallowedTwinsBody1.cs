...
namespace Archeon.NPCs.Bosses.TheHallowedOne.HallowedTwins
{
	...
	public class HallowedTwinsBody1 : ModNPC
	{
		...
		public override bool PreAI()
		{
			...
			{	
				...
				{
					Projectile.NewProjectile(base.npc.position, new Vector2(0f), base.mod.ProjectileType("HallowedOneShotDownNoMove"), 22, 11f, 255, 0f, 0f);
				}
