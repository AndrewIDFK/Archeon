...
{
    public class DefenseOrbHealingUp2 : ModProjectile
    {
		...
		public override void Kill(int timeLeft)
		{
			...
			Projectile.NewProjectile(base.projectile.Center.X + 6.5f, base.projectile.Center.Y + 6.5f, projectile.velocity.X, projectile.velocity.Y - 26.2f, base.mod.ProjectileType("DefenseOrbHealing"), base.projectile.damage, base.projectile.knockBack, Main.myPlayer, 0f, 0f);
		}
    }
}