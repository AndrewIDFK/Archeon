...
{
	public class BloodyArrowProj : ModProjectile
	{
		...
		public override void Kill(int timeLeft)
		{
			...
			for(int i = 0; i < 6; i++)
			{
				int num = Dust.NewDust(projectile.position + projectile.velocity, projectile.width, projectile.height, 125, projectile.velocity.X / 10, projectile.velocity.Y / 10, 0, Color.Crimson, 1f);
