...
{
	public class OceanicGlaiveSpear : ModProjectile
	{
		...
		public override void AI()
		{
			...
			if (!player.frozen)
			{
				...
				if (player.itemAnimation == player.itemAnimationMax / 3)
				{
					Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, projectile.velocity.X * 3.5f, projectile.velocity.Y * 3.5f, mod.ProjectileType("OceanicGlaiveBeam"), projectile.damage, projectile.knockBack, projectile.owner, 0f, 0f);
				}
			}
