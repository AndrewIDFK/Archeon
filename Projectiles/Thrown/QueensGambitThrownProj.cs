...
{
	public class QueensGambitThrownProj : ModProjectile
	{
		...
		{	
			...
			{
				int yStuff = Main.rand.Next(-4, 4);
				Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, projectile.velocity.X / 1.1f, yStuff, ProjectileID.Bee, Main.player[projectile.owner].beeDamage(projectile.damage / 3), 0, projectile.owner, 0f, 0f);
			}*/
