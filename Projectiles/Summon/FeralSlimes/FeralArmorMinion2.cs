...
{
	public class FeralArmorMinion2 : FeralArmorMinionAI
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Venomous Slime");
		...
		public override void AI()
		{
			...
			bool flag = projectile.type == mod.ProjectileType("FeralArmorMinion2");
		...
		public override void CreateDust()
		{
			if (projectile.ai[0] == 0f)
			{
				...
				{
					int num = Dust.NewDust(projectile.position, projectile.width, projectile.height / 2, 40, 0f, 0f, 0, default(Color), 1f);
			...
			else if (Utils.NextBool(Main.rand, 3))
			{
				...
				int num2 = Dust.NewDust(projectile.position, projectile.width, projectile.height, 40, 0f, 0f, 0, default(Color), 1f);
