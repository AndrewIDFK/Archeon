...
namespace Archeon.Items.Armor.Shadonium
{
	...
	public class ShadoniumLeggings : ModItem
	{
		...
		{
			base.DisplayName.SetDefault("Shadonium Greaves");
			base.Tooltip.SetDefault("10% increased movement speed \nReduces damage taken by 4%");
		}
		...
		public override void AddRecipes()
		{
			...
			modRecipe.AddIngredient(base.mod.ItemType("ShadoniumBar"), 14);
