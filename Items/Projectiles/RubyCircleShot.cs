...
namespace Archeon.Items.Projectiles
{
	...
	public class RubyCircleShot : ModProjectile
	{
		...
		public override void AI()
			{
				...
				int numxd = Dust.NewDust(base.projectile.position + base.projectile.velocity, base.projectile.width, base.projectile.height, 60, base.projectile.velocity.X * 2f, base.projectile.velocity.Y * 2f, 100, default(Color), 1.4f);
				...
				bool flag = base.projectile.type == base.mod.ProjectileType("RubyCircleShot");
				MyPlayer modPlayer = player.GetModPlayer<MyPlayer>();
				if (modPlayer.RubyCircleS)
				{
