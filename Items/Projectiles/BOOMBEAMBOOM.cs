...
namespace Archeon.Items.Projectiles
{
	...
	public class BOOMBEAMBOOM : ModProjectile
	{
			...
			else
			{
				if (Math.Abs(base.projectile.velocity.X) >= 9f || Math.Abs(base.projectile.velocity.Y) >= 9f)
				{
					for (int i = 0; i < 3; i++)
					{
						...
						int num3 = Dust.NewDust(new Vector2(base.projectile.position.X + 4f + num, base.projectile.position.Y + 4f + num2) - base.projectile.velocity * 0.5f, base.projectile.width - 6, base.projectile.height - 6, base.mod.DustType("HalloweenDust1"), 0f, 0f, 100, default(Color), 0.5f);
						Main.dust[num3].scale *= 1.62f + (float)Main.rand.Next(9) * 0.15f;
				...
				{
					int num4 = Dust.NewDust(new Vector2(base.projectile.position.X, base.projectile.position.Y), base.projectile.width, base.projectile.height, base.mod.DustType("HalloweenDust1"), 0f, 0f, 100, default(Color), 0.5f);
					...
					Main.rand.Next(2);
					num4 = Dust.NewDust(new Vector2(base.projectile.position.X, base.projectile.position.Y), base.projectile.width, base.projectile.height, base.mod.DustType("HalloweenDust1"), 0f, 0f, 100, default(Color), 0.5f);
		...
		public override void Kill(int timeLeft)
		{
			...
			for (int i = 0; i < 35; i++)
			{
				int num = Dust.NewDust(new Vector2(base.projectile.position.X, base.projectile.position.Y), base.projectile.width, base.projectile.height, base.mod.DustType("HalloweenDust1"), 0f, 0f, 100, default(Color), 1f);
			...
			for (int j = 0; j < 42; j++)
			{
				int num2 = Dust.NewDust(new Vector2(base.projectile.position.X, base.projectile.position.Y), base.projectile.width, base.projectile.height, base.mod.DustType("HalloweenDust1"), 0f, 0f, 100, default(Color), 2f);
				Main.dust[num2].noGravity = true;
				Main.dust[num2].velocity *= 5f;
				num2 = Dust.NewDust(new Vector2(base.projectile.position.X, base.projectile.position.Y), base.projectile.width, base.projectile.height, base.mod.DustType("HalloweenDust1"), 0f, 0f, 100, default(Color), 1f);
