...
namespace Archeon.Items.Projectiles
{
	...
	public class RingFireShot : ModProjectile
	{
		...
		public override void SetDefaults()
		{
			...
			base.projectile.penetrate = 25;
			base.projectile.timeLeft = 380;
		...
		{		
			Lighting.AddLight(base.projectile.Center, 1.275f, 0.25f, 0.06f); 
			
			int num = Dust.NewDust(base.projectile.position + base.projectile.velocity, base.projectile.width, base.projectile.height, 6, base.projectile.velocity.X * 2f, base.projectile.velocity.Y * 2f, 100, default(Color), 1.4f);
			Main.dust[num].velocity /= 60f;
			Main.dust[num].scale = 1.4f;
			Main.dust[num].noGravity = true;
			
			int num2 = Dust.NewDust(base.projectile.position + base.projectile.velocity, base.projectile.width, base.projectile.height, 127, base.projectile.velocity.X * 2f, base.projectile.velocity.Y * 2f, 100, default(Color), 1.4f);
		...
		public override void Kill(int timeLeft)
		{
			...
			for (int i = 0; i < 5; i++)
			{
				int num = Dust.NewDust(base.projectile.position + base.projectile.velocity, base.projectile.width, base.projectile.height, 127, 0f, 0f, 0, default(Color), 1f);
		...
		{
			return new Color?(new Color(204, 102, 0, 0));
		}
