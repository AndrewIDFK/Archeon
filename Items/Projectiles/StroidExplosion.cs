...
namespace Archeon.Items.Projectiles
{
	...
	public class StroidExplosion : ModProjectile
	{
		...
		public override void ModifyHitNPC(NPC target, ref int damage, ref float knockback, ref bool crit, ref int hitDirection)
		{
			...
			target.AddBuff(BuffType<Buffs.StroidDebuff>(), 95); // Adds the ExampleJavelin debuff for a very small DoT
		}
			...
			else
			{
				if (Math.Abs(base.projectile.velocity.X) >= 9f || Math.Abs(base.projectile.velocity.Y) >= 9f)
				{
					for (int i = 0; i < 3; i++)
					{
						...
						int num3 = Dust.NewDust(new Vector2(base.projectile.position.X + 4f + num, base.projectile.position.Y + 4f + num2) - base.projectile.velocity * 0.5f, base.projectile.width - 6, base.projectile.height - 6, base.mod.DustType("StroidDust1"), 0f, 0f, 100, default(Color), 0.5f);
				...
				{
					int num4 = Dust.NewDust(new Vector2(base.projectile.position.X, base.projectile.position.Y), base.projectile.width, base.projectile.height, base.mod.DustType("StroidDust1"), 0f, 0f, 100, default(Color), 0.5f);
					...
					Main.rand.Next(2);
					num4 = Dust.NewDust(new Vector2(base.projectile.position.X, base.projectile.position.Y), base.projectile.width, base.projectile.height, base.mod.DustType("StroidDeathDust"), 0f, 0f, 100, default(Color), 0.5f);
