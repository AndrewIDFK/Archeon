...
namespace Archeon.Items.Projectiles.GemProj
{
	...
	public class DiamondPrism : ModProjectile
	{
		...
		public override void Kill(int Timeleft)
		{
			...
			for (int i = 0; i < numberProjectiles; i++)
			{
				...
				value *= scaleFactor;
				Projectile.NewProjectile(base.projectile.Center.X, base.projectile.Center.Y, value.X, value.Y, base.mod.ProjectileType("DiamondPrism2"), base.projectile.damage, base.projectile.knockBack, Main.myPlayer, 0f, 0f);
			}
