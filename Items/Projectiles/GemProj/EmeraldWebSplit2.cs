...
namespace Archeon.Items.Projectiles.GemProj
{
	...
	public class EmeraldWebSplit2 : ModProjectile
	{
		...
		public override void AI()
		{
			...
			if (base.projectile.localAI[0] > 3f)
			{
				for (int i = 0; i < 8; i++)
				{
					...
					Main.dust[num].scale = (float)Main.rand.Next(52, 70) * 0.0215f;
		...
		public override void Kill(int Timeleft)
		{
			...
			for (int i = 0; i < numberProjectiles; i++)
			{
				...
				value *= scaleFactor;
				Projectile.NewProjectile(base.projectile.Center.X - 5, base.projectile.Center.Y - 8, value.X, value.Y, base.mod.ProjectileType("EmeraldWeb3"), base.projectile.damage, base.projectile.knockBack, Main.myPlayer, 0f, 0f);
			}
