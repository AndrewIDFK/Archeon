...
namespace Archeon.Items.Projectiles.GemProj
{
	...
	public class AmethystWeb2 : ModProjectile
	{
		...
		public override void Kill(int Timeleft)
		{
			...
			for (int i = 0; i < numberProjectiles; i++)
			{
				...
				value *= scaleFactor;
				Projectile.NewProjectile(base.projectile.Center.X, base.projectile.Center.Y - 5, value.X, value.Y, base.mod.ProjectileType("AmethystWeb3"), base.projectile.damage, base.projectile.knockBack, Main.myPlayer, 0f, 0f);
			}
			...
			Projectile.NewProjectile(base.projectile.Center.X - 4.5f, base.projectile.Center.Y + 4.5f, projectile.velocity.X, projectile.velocity.Y - 8.21f, base.mod.ProjectileType("AmethystWebSplit"), base.projectile.damage, base.projectile.knockBack, Main.myPlayer, 0f, 0f);
