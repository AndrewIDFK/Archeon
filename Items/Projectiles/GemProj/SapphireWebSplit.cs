...
namespace Archeon.Items.Projectiles.GemProj
{
	...
	public class SapphireWebSplit : ModProjectile
	{
		...
		public override void Kill(int Timeleft)
		{
			...
			{
				Vector2 value = Utils.RotatedByRandom(new Vector2(projectile.velocity.X, projectile.velocity.Y), (double)MathHelper.ToRadians(94f));
				float scaleFactor = 1.29f - Utils.NextFloat(Main.rand) * 0.88f;
				value *= scaleFactor;
				Projectile.NewProjectile(base.projectile.Center.X + 4, base.projectile.Center.Y - 8, value.X, value.Y, base.mod.ProjectileType("SapphireWebSplit2"), base.projectile.damage, base.projectile.knockBack, Main.myPlayer, 0f, 0f);
			}
