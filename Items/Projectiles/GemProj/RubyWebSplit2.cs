...
namespace Archeon.Items.Projectiles.GemProj
{
	...
	public class RubyWebSplit2 : ModProjectile
	{
		...
		public override void Kill(int Timeleft)
		{
			...
			for (int i = 0; i < numberProjectiles; i++)
			{
				...
				value *= scaleFactor;
				Projectile.NewProjectile(base.projectile.Center.X - 4, base.projectile.Center.Y + 8, value.X, value.Y, base.mod.ProjectileType("RubyWeb3"), base.projectile.damage, base.projectile.knockBack, Main.myPlayer, 0f, 0f);
			}
