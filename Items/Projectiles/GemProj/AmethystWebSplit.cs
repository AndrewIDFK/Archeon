...
namespace Archeon.Items.Projectiles.GemProj
{
	...
	public class AmethystWebSplit : ModProjectile
	{
		...
		public override void Kill(int Timeleft)
		{
			...
			for (int i = 0; i < numberProjectiles; i++)
			{
				...
				value *= scaleFactor;
				Projectile.NewProjectile(base.projectile.Center.X - 7, base.projectile.Center.Y + 3, value.X, value.Y, base.mod.ProjectileType("AmethystWebSplit2"), base.projectile.damage, base.projectile.knockBack, Main.myPlayer, 0f, 0f);
			}
