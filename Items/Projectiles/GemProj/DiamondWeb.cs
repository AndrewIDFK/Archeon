...
namespace Archeon.Items.Projectiles.GemProj
{
	...
	public class DiamondWeb : ModProjectile
	{
		...
		public override void AI()
		{
			...
			if (base.projectile.localAI[0] > 3f)
			{
				for (int i = 0; i < 8; i++)
				{
					...
					int num = Dust.NewDust(vector, 1, 1, 63, 0f, 0f, 0, default(Color), 0.8f);
		...
		public override void Kill(int Timeleft)
		{
			...
			for (int i = 0; i < numberProjectiles; i++)
			{
				...
				value *= scaleFactor;
				Projectile.NewProjectile(base.projectile.Center.X, base.projectile.Center.Y, value.X, value.Y, base.mod.ProjectileType("DiamondWeb2"), base.projectile.damage, base.projectile.knockBack, Main.myPlayer, 0f, 0f);
			}
