...
namespace Archeon.Items.Projectiles.GemProj
{
	...
	public class EmeraldWebSplit : ModProjectile
	{
		...
		public override void Kill(int Timeleft)
		{
			...
			for (int i = 0; i < numberProjectiles; i++)
			{
				...
				value *= scaleFactor;
				Projectile.NewProjectile(base.projectile.Center.X - 5, base.projectile.Center.Y - 8, value.X, value.Y, base.mod.ProjectileType("EmeraldWebSplit2"), base.projectile.damage, base.projectile.knockBack, Main.myPlayer, 0f, 0f);
			}
