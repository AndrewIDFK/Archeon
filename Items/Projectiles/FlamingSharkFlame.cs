...
namespace Archeon.Items.Projectiles
{
	...
	public class FlamingSharkFlame : ModProjectile
	{
		// Token: 0x060012F7 RID: 4855 RVA: 0x0007E1A7 File Offset: 0x0007C3A7
		public override void SetStaticDefaults()
		{
			base.DisplayName.SetDefault("Magmashark Flame");
		}
		...
		public override void Kill(int timeLeft)
		{
			for (int i = 0; i < 5; i++)
			{
				int num2 = Dust.NewDust(base.projectile.position + base.projectile.velocity, base.projectile.width, base.projectile.height, 6, base.projectile.oldVelocity.X * 0.5f, base.projectile.oldVelocity.Y * 0.5f, 0, default(Color), 1f);
				Main.dust[num2].noGravity = true;
			}
		}
