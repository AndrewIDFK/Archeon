...
namespace Archeon.Items.Projectiles
{
	...
	public class EmeraldCircleShot : ModProjectile
	{
		...
		public override void AI()
			{
				...
				int numxd = Dust.NewDust(base.projectile.position + base.projectile.velocity, base.projectile.width, base.projectile.height, 61, base.projectile.velocity.X * 2f, base.projectile.velocity.Y * 2f, 100, default(Color), 1.4f);
				...
				bool flag = base.projectile.type == base.mod.ProjectileType("EmeraldCircleShot");
				MyPlayer modPlayer = player.GetModPlayer<MyPlayer>();
				if (modPlayer.EmeraldCircleS)
				{
