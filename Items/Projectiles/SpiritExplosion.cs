	...
	public class SpiritExplosion : ModProjectile
	{
		...
		public override void AI()
		{
			...
			else
			{
				...
				{
					int num4 = Dust.NewDust(new Vector2(base.projectile.position.X, base.projectile.position.Y), base.projectile.width, base.projectile.height, base.mod.DustType("SpoopDust1"), 0f, 0f, 100, default(Color), 0.5f);
					...
					Main.rand.Next(2);
					num4 = Dust.NewDust(new Vector2(base.projectile.position.X, base.projectile.position.Y), base.projectile.width, base.projectile.height, base.mod.DustType("SpoopDust1"), 0f, 0f, 100, default(Color), 0.5f);
		...
		public override void Kill(int timeLeft)
		{
			...
			for (int i = 0; i < 35; i++)
			{
				int num = Dust.NewDust(new Vector2(base.projectile.position.X, base.projectile.position.Y), base.projectile.width, base.projectile.height, base.mod.DustType("SpoopDust1"), 0f, 0f, 100, default(Color), 1f);
			...
			for (int j = 0; j < 42; j++)
			{
				int num2 = Dust.NewDust(new Vector2(base.projectile.position.X, base.projectile.position.Y), base.projectile.width, base.projectile.height, base.mod.DustType("SpoopDust1"), 0f, 0f, 100, default(Color), 2f);
				Main.dust[num2].noGravity = true;
				Main.dust[num2].velocity *= 5f;
				num2 = Dust.NewDust(new Vector2(base.projectile.position.X, base.projectile.position.Y), base.projectile.width, base.projectile.height, base.mod.DustType("SpoopDust1"), 0f, 0f, 100, default(Color), 1f);
