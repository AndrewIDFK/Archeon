...
namespace Archeon.Items.Projectiles
{
	...
	public class PumpkinChunkerChunk : ModProjectile
	{
		// Token: 0x0600155E RID: 5470 RVA: 0x000839D6 File Offset: 0x00081BD6
		public override void SetStaticDefaults()
		{
			base.DisplayName.SetDefault("Pump Chunk");
		}
		...
		public override void AI()
		{
			...
			{
				Dust.NewDust(base.projectile.position + base.projectile.velocity, base.projectile.width, base.projectile.height, base.mod.DustType("HalloweenDust1"), base.projectile.velocity.X * 0.5f, base.projectile.velocity.Y * 0.5f, 0, default(Color), 1f);
			}
		}
		...
		public override void Kill(int timeLeft)
		{
			for (int i = 0; i < 10; i++)
			{
				Dust.NewDust(base.projectile.position + base.projectile.velocity, base.projectile.width, base.projectile.height, base.mod.DustType("HalloweenDust1"), base.projectile.oldVelocity.X * 0.5f, base.projectile.oldVelocity.Y * 0.5f, 0, default(Color), 1f);
			}
		}
	}
}
