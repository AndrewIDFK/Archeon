...
namespace Archeon.Items.Projectiles.Minions
{
	...
	public class DarkMatterTornado2 : ModProjectile
	{
		...
		public override void AI()
		{
			if (base.projectile.localAI[1] == 0f)
			{
				...
				for (int i = 0; i < num; i++)
				{
					...
					int num2 = Dust.NewDust(value + vector, 0, 0, base.mod.DustType("DarkMatterDust2"), vector.X * 1.5f, vector.Y * 1.5f, 100, default(Color), 1.4f);
			...
			int num666 = Dust.NewDust(base.projectile.position, base.projectile.width, base.projectile.height, base.mod.DustType("DarkMatterDust2"), 0f, 0f, 0, default(Color), 1f);
			Main.dust[num666].velocity *= 0.1f;
			Main.dust[num666].scale = 1.4f;
			Main.dust[num666].noGravity = true;
			
			bool flag = base.projectile.type == base.mod.ProjectileType("DarkMatterTornado2");
			...
			{
				int num13 = Dust.NewDust(new Vector2(base.projectile.position.X, base.projectile.position.Y), base.projectile.width, base.projectile.height, base.mod.DustType("DarkMatterDust2"), 0f, 0f, 100, default(Color), 2f);
